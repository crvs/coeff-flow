...
struct quotient::impl {
  ...
  impl(const simplicial_complex &s_comp, bool(f)(point_t), point_t b_point) {
    impl(s_comp, f);
    this->base_point = b_point;
  }

  // TODO implement and refactor above
...
/* TODO
 * fill in details
quotient::quotient(const quotient&);
quotient::quotient& operator=(const quotient&);
